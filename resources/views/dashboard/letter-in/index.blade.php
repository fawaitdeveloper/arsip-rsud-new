    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            <div class="table-responsive text-nowrap p-2">
                <table class="table table-striped table-hover" id="tablenaskahmasuk">
                    <caption class="ms-4">
                        Data Tujuan
                    </caption>
                    <thead>
...
@push('customjs')
    <script>
        $(document).ready(function() {
            ...
            const table = $("#tablenaskahmasuk").DataTable({
                processing: true,
                serverSide: true,
                ordering: false,
                language: {
                ...
                columns: [{
                    ...
                    data: null,
                    render: function(data, type, row, meta) {
                        return `<a href="/naskah-masuk/${data.id}"><i class="bx bx-low-vision"></i></a>`
                    }
                }]
            })
