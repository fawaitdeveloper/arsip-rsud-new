      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td> <strong>{{ $position->workUnit->name ?? ""}}</strong></td>
            <td>
              <span class="badge {{ $position->isActive ? 'bg-label-success' : 'bg-label-warning' }} me-1">
            ...
            <td>
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  ...
                  <form method="POST" action="/jabatan/{{ $position->id }}">
                    @method('delete')
                    @csrf
